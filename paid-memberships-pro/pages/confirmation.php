...
<?php if(!empty($pmpro_invoice) && !empty($pmpro_invoice->id)) { ?>		
	...
	<?php
		...
		$confirmation_message .= "<p>" . sprintf(__('Below are details about your membership account and a receipt for your initial membership invoice. A welcome email with a copy of your initial membership invoice has been sent to %s.', 'paid-memberships-pro' ), $pmpro_invoice->user->user_email) . '</p><p>To print or view your membership card, visit your <a href="/membership-account/">Membership Account</a>.</p>';
...
<?php 
	...
	{
		$confirmation_message .= "<p>" . sprintf(__('Below are details about your membership account. A welcome email has been sent to %s.', 'paid-memberships-pro' ), $current_user->user_email) . '</p><p>To print or view your membership card, visit your <a href="/membership-account/">Membership Account</a>.</p>';
