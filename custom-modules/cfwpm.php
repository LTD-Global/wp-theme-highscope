...
class Custom_ET_Builder_Module_Login extends ET_Builder_Module {
	function init() {
				...
				<div class="et_pb_newsletter_form et_pb_login_form">
					<form action="%7$s" method="post">
						<p>
							...
							<input id="user_login_%12$s" placeholder="Username or Email" class="input" type="text" value="" name="log" />
						</p>
						<p>
