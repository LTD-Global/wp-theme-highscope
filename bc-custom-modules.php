...
class DS_Custom_Module_Person extends ET_Builder_Module {
	function init() {
		$this->name             = esc_html__( 'Person Extended', 'et_builder' );
		$this->slug             = 'et_pb_person_blurb';
	...
	function get_fields() {
		...
		$fields = array(
			'title' => array(
				...
				'description'     => esc_html__( 'The name of your person will appear in bold below your image image.', 'et_builder' ),
