...
<style>
	...
	.pmpro_membership_card-print p {font-size: 12px; margin: 10px 0 0 0; padding: 0; line-height: 22px;}
	img.pmpro_membership_card_image {border: none; box-shadow: none; float: none;}
	.pmpro_membership_card-print-md .pmpro_membership_card_image {max-width: 150px;}
	.pmpro_membership_card-print-md img.pmpro_membership_card_image {margin-bottom: 1%;}
	...
	{	
		...
		<?php if(!empty($print_medium)) { ?>
			...
			.pmpro_membership_card-print-md .pmpro_membership_card-inner p {line-height: 16px;}
